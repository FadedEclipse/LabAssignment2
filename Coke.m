function Coke(ur3,kuka,Coke_h,vertices,transformedVertices,BartransformedVertices,BenchtransformedVertices)


q1 = [1.5708   -1.5708         0   -1.5709    3.1416        -1.5708];

%KUKA TRANSPORTS COKE BOTTLE

%kuka moves from inital zeros pos to bottle home position
q1kuka = [ 0     0     0     0     0     0];
qWaypoints = [q1kuka ...
    ; [2.9671    0.2871   -0.7707         0   -0.6981         0] ...
    ; [3.4208   -0.4511   -0.1445         0   -0.5306    1.5708]];
...
q1kuka = [3.4208   -0.4511   -0.1445         0   -0.5306    1.5708];
qWaypoints = [q1kuka ...
